...
public class NewIntern {
    ...
    public void addIntern(JFXTextField fullName, JFXTextField whatsappNo, JFXRadioButton male, JFXRadioButton female, ComboBox course, JFXDatePicker datePicker, Stage stage) throws SQLException {
        ...
        if ((fullName.getText() != null || fullName.getText().matches(fullNameChecker)) && (whatsappNo.getText().matches(numberChecker) || whatsappNo.getText() != null) && (course.getValue() != null) && (datePicker.getValue() != null) && (male.isSelected() || female.isSelected())) {
